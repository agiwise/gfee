...
import ma.iam.wissal.service.mapper.FournisseurMapper;
...
class FournisseurResourceIT {
    ...
    public static Fournisseur createEntity(EntityManager em) {
        Fournisseur fournisseur = new Fournisseur().libelle(DEFAULT_LIBELLE).idDLC(DEFAULT_ID_DLC);
        return fournisseur;
    }
    ...
    public static Fournisseur createUpdatedEntity(EntityManager em) {
        Fournisseur fournisseur = new Fournisseur().libelle(UPDATED_LIBELLE).idDLC(UPDATED_ID_DLC);
        return fournisseur;
    }
    ...
    void createFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getIdDLC()).isEqualTo(DEFAULT_ID_DLC);
    }
    ...
    void putNewFournisseur() throws Exception {
        ...
        updatedFournisseur.libelle(UPDATED_LIBELLE).idDLC(UPDATED_ID_DLC);
        ...
        assertThat(testFournisseur.getIdDLC()).isEqualTo(UPDATED_ID_DLC);
    }
    ...
    void partialUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.idDLC(UPDATED_ID_DLC);
    ...
    void fullUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.libelle(UPDATED_LIBELLE).idDLC(UPDATED_ID_DLC);
