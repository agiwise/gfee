package ma.iam.wissal.config.timezone;
...
import ma.iam.wissal.repository.timezone.DateTimeWrapper;
import ma.iam.wissal.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM gfee_date_time_wrapper where id=%d", fieldName, id);
    }
