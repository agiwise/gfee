...
public class Facture implements Serializable {
    ...
    @Column(name = "categorie_facture")
    private Integer categorieFacture;

    @Column(name = "puissance_appelee")
    ...
    @Column(name = "ancien_index_ean")
    private Long ancienIndexEan;

    @Column(name = "nouvel_index_ean")
    private Long nouvelIndexEan;

    @Column(name = "ea_normale")
    private String eaNormale;

    @Column(name = "ancien_index_eac")
    private Long ancienIndexEac;

    @Column(name = "nouvel_index_eac")
    private Long nouvelIndexEac;

    @Column(name = "ea_creuse")
    private Long eaCreuse;

    @Column(name = "ancien_index_eap")
    private Long ancienIndexEap;

    @Column(name = "nouvel_index_eap")
    private Long nouvelIndexEap;

    @Column(name = "ea_pointes")
    private String eaPointes;

    @Column(name = "energie_reactive")
    private Float energieReactive;

    @Column(name = "heures_utilisees")
    private Long heuresUtilisees;

    @Column(name = "indice_maximal")
    ...
    @Column(name = "date_rendre_facture_as")
    ...
    @Column(name = "id_user_validation")
    private Long idUserValidation;

    @Column(name = "id_user_rejet")
    private Long idUserRejet;

    @Column(name = "id_user_modification")
    private Long idUserModification;

    @Column(name = "id_user_suppression")
    private Long idUserSuppression;

    @Column(name = "id_user_rendre_facture_as")
    ...
    @Column(name = "ancien_index_ea")
    private Long ancienIndexEa;

    @Column(name = "nouvel_index_ea")
    private Long nouvelIndexEa;

    @Column(name = "ancien_index_er")
    private Long ancienIndexEr;

    @Column(name = "nouvel_index_er")
    private Long nouvelIndexEr;

    @Column(name = "ancien_index_hu")
    private Long ancienIndexHu;

    @Column(name = "nouvel_index_hu")
    private Long nouvelIndexHu;

    @Column(name = "ancien_index_im")
    private Long ancienIndexIm;

    @Column(name = "nouvel_index_im")
    private Long nouvelIndexIm;

    @Column(name = "montant_tva_7")
    private Double montantTVA7;

    @Column(name = "montant_ht_7")
    private Double montantHT7;

    @Column(name = "montant_tva_14")
    private Double montantTVA14;

    @Column(name = "montant_ht_14")
    private Double montantHT14;

    @Column(name = "montant_tva_20")
    private Double montantTVA20;

    @Column(name = "montant_ht_20")
    private Double montantHT20;

    @Column(name = "montant_tva_manue")
    private Double montantTvaManue;

    @Column(name = "diverses_taxes")
