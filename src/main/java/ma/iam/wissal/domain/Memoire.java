...
public class Memoire implements Serializable {
    ...
    @Column(name = "num_piece_sap")
    private Long numPieceSap;

    @Column(name = "num_ov")
    private Long numOv;

    @Column(name = "date_comptable_reelle")
    ...
    @Column(name = "id_user_comptabilisation")
    private Long idUserComptabilisation;

    @Column(name = "id_user_paiement")
    private Long idUserPaiement;

    @Column(name = "id_user_devalidation")
