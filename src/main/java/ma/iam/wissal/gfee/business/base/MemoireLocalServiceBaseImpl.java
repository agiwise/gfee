...
/*     */ 
/*     */ public abstract class MemoireLocalServiceBaseImpl
/*     */   implements MemoireLocalService
/*     */ {
/*     */ 
...
/*     */   {
/*     */ 
/*  89 */     return this.memoireRepository.save(memoire);
/*     */   }
/*     */ 
/*     */   public void deleteMemoire(long idMemoire) throws Exception, RuntimeException
/*     */   {
/*  98 */     this.memoireRepository.deleteById(idMemoire);
/*     */   }
/*     */ 
/*     */   public void deleteMemoire(Memoire memoire) throws RuntimeException {
/* 102 */     this.memoireRepository.deleteById(memoire.getId());
/*     */   }
/*     */ 
/*     */   public Memoire getMemoire(long idMemoire) throws Exception, RuntimeException
/*     */   {
/* 117 */     return this.memoireRepository.findById(idMemoire).get();
/*     */   }
/*     */ 
/*     */   public List<Memoire> getMemoires() throws RuntimeException
/*     */   {
/* 122 */     return this.memoireRepository.findAll();
/*     */   }
/*     */ 
/*     */   public int getMemoiresCount() throws RuntimeException {
/* 126 */      return (int) this.memoireRepository.count();
/*     */   }
/*     */ 
/*     */   public Memoire updateMemoire(Memoire memoire) throws RuntimeException {
/*     */ 
/* 132 */     return this.memoireRepository.save(memoire);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     ma.iam.wissal.gfee.business.base.MemoireLocalServiceBaseImpl
