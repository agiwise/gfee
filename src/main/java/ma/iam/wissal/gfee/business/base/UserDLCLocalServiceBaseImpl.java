...
/*     */ 
/*     */ public abstract class UserDLCLocalServiceBaseImpl
/*     */   implements UserDLCLocalService
/*     */ {
/*     */ 
...
/*     */ 
/*     */   public UserDLC addUserDLC(UserDLC userDLC)
/*     */     throws RuntimeException
/*     */   {
/*     */ 
/*  89 */     return this.userDLCRepository.save(userDLC);
/*     */   }
/*     */ 
/*     */   public void deleteUserDLC(long idUserDLC) throws Exception, RuntimeException
/*     */   {
/*  98 */     this.userDLCRepository.deleteById(idUserDLC);
/*     */   }
/*     */ 
/*     */   public void deleteUserDLC(UserDLC userDLC) throws RuntimeException {
/* 102 */     this.userDLCRepository.deleteById(userDLC.getId());
/*     */   }
/*     */ 
/*     */   public UserDLC getUserDLC(long idUserDLC) throws Exception, RuntimeException
/*     */   {
/* 117 */     return this.userDLCRepository.findById(idUserDLC).get();
/*     */   }
/*     */ 
/*     */   public List<UserDLC> getUserDLCs() throws RuntimeException
/*     */   {
/* 122 */     return this.userDLCRepository.findAll();
/*     */   }
/*     */ 
/*     */   public int getUserDLCsCount() throws RuntimeException {
/* 126 */     return (int) this.userDLCRepository.count();
/*     */   }
/*     */ 
/*     */   public UserDLC updateUserDLC(UserDLC userDLC) throws RuntimeException {
/*     */ 
/* 132 */     return this.userDLCRepository.save(userDLC);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     ma.iam.wissal.gfee.business.base.UserDLCLocalServiceBaseImpl
