...
/*     */   {
/*     */ 
/*  91 */     return this.fournisseurRepository.save(fournisseur);
/*     */   }
/*     */ 
/*     */   public void deleteFournisseur(long idFournisseur) throws Exception, RuntimeException
/*     */   {
/* 100 */     this.fournisseurRepository.deleteById(idFournisseur);
/*     */   }
/*     */ 
/*     */   public void deleteFournisseur(Fournisseur fournisseur) throws RuntimeException
/*     */   {
/* 105 */     this.fournisseurRepository.deleteById(fournisseur.getId());
/*     */   }
/*     */ 
/*     */   public Fournisseur getFournisseur(long idFournisseur)
/*     */     throws Exception, RuntimeException
/*     */   {
/* 121 */     return this.fournisseurRepository.findById(idFournisseur).get();
/*     */   }
/*     */ 
/*     */   public List<Fournisseur> getFournisseurs() throws RuntimeException
/*     */   {
/* 126 */     return this.fournisseurRepository.findAll();
/*     */   }
/*     */ 
/*     */   public int getFournisseursCount() throws RuntimeException {
/* 130 */     return (int) this.fournisseurRepository.count();
/*     */   }
/*     */ 
/*     */   public Fournisseur updateFournisseur(Fournisseur fournisseur) throws RuntimeException
/*     */   {
/*     */ 
/* 137 */     return this.fournisseurRepository.save(fournisseur);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     ma.iam.wissal.gfee.business.base.FournisseurLocalServiceBaseImpl
