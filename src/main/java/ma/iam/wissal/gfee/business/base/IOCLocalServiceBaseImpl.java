...
/*     */ 
/*     */ public abstract class IOCLocalServiceBaseImpl
/*     */   implements IOCLocalService
/*     */ {
/*     */ 
...
/*     */   {
/*     */ 
/*  89 */     return this.iocRepository.save(ioc);
/*     */   }
/*     */ 
/*     */   public void deleteIOC(long idIoc) throws Exception, RuntimeException {
/*  97 */     this.iocRepository.deleteById(idIoc);
/*     */   }
/*     */ 
/*     */   public void deleteIOC(IOC ioc) throws RuntimeException {
/* 101 */     this.iocRepository.deleteById(ioc.getId());
/*     */   }
/*     */ 
/*     */   public IOC getIOC(long idIoc) throws Exception, RuntimeException {
/* 115 */     return this.iocRepository.findById(idIoc).get();
/*     */   }
/*     */ 
/*     */   public List<IOC> getIOCs() throws RuntimeException {
/* 119 */     return this.iocRepository.findAll();
/*     */   }
/*     */ 
/*     */   public int getIOCsCount() throws RuntimeException {
/* 123 */     return (int) this.iocRepository.count();
/*     */   }
/*     */ 
/*     */   public IOC updateIOC(IOC ioc) throws RuntimeException {
/*     */ 
/* 129 */     return this.iocRepository.save(ioc);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     ma.iam.wissal.gfee.business.base.IOCLocalServiceBaseImpl
