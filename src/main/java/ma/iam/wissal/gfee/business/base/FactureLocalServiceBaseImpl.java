...
/*     */ 
/*     */ public abstract class FactureLocalServiceBaseImpl
/*     */   implements FactureLocalService
/*     */ {
/*     */ 
...
/*     */   {
/*  89 */     return this.factureRepository.save(facture);
/*     */   }
/*     */ 
/*     */   public void deleteFacture(long idFacture) throws Exception, RuntimeException
/*     */   {
/*  98 */     this.factureRepository.deleteById(idFacture);
/*     */   }
/*     */ 
/*     */   public void deleteFacture(Facture facture) throws RuntimeException {
/* 102 */     this.factureRepository.deleteById(facture.getId());
/*     */   }
/*     */ 
/*     */   public Facture getFacture(long idFacture) throws Exception, RuntimeException
/*     */   {
/* 117 */     return this.factureRepository.findById(idFacture).get();
/*     */   }
/*     */ 
/*     */   public List<Facture> getFactures() throws RuntimeException
/*     */   {
/* 122 */     return this.factureRepository.findAll();
/*     */   }
/*     */ 
/*     */   public int getFacturesCount() throws RuntimeException {
/* 126 */     return (int) this.factureRepository.count();
/*     */   }
/*     */ 
/*     */   public Facture updateFacture(Facture facture) throws RuntimeException {
/*     */ 
/* 132 */     return this.factureRepository.save(facture);
/*     */   }
/*     */ 
 ...
 * Qualified Name:     ma.iam.wissal.gfee.business.base.FactureLocalServiceBaseImpl
