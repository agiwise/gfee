...
public class IOC implements Serializable {
    ...
    @Column(name = "puissancesouscrite")
    private String puissanceSouscrite;

    @Column(name = "puissanceinstalle")
    ...
    @Column(name = "responsablesite")
    private String responsableSite;

    @Column(name = "activiteanalytique")
    private Integer activiteAnalytique;

    @Column(name = "codeanalytique")
    private String codeAnalytique;

    @Column(name = "categorieindex")
